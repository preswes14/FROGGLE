...
function T(baseTime) {
  // Note: Use !== undefined to properly handle 0 (instant mode)
  const speed = (typeof S !== 'undefined' && S.animationSpeed !== undefined) ? S.animationSpeed : 1;
