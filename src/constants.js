...
SoundFX.play('ribbit');
// Check if this is actually the last fly
const aliveEnemies = S.enemies.filter(e => e.h > 0);
if(aliveEnemies.length === 1) {
// Last fly - Tapo eats it and combat ends
...
// Multiple flies remain - Tapo just saves Mage, combat continues
toast("Tapo leaps in front of Mage, absorbing the blow! Keep fighting!", 2500);
}
