...
{
q: "How do I spend XP after combat?",
a: `After combat, you can spend XP in 3 ways:<br><br>
<strong>1. UPGRADE A SIGIL</strong> (makes it stronger everywhere!)<br>
<strong style="color:#9333ea">Passive Sigils</strong> (Expand, Asterisk, Star) start at Level 0 (inactive). Spend XP to activate them for ALL heroes automatically.<br>
<strong style="color:#2c63c7">Active Sigils</strong> (Attack, Shield, Heal, D20, etc.) start at Level 1. Upgrading makes them stronger on every hero who has them. Example: Attack L1→L2 means attack twice instead of once!<br><br>
<strong>2. ADD A SIGIL TO A HERO</strong><br>
All heroes can learn any sigil by spending XP! Active sigils use your hero's 1 action per turn. Choose abilities that complement your strategy.<br><br>
<strong>3. UPGRADE HERO STATS</strong><br>
Spend XP for +1 POW (increases damage/healing/shields) or +5 Max HP (and heal if in Last Stand).`
},
{
...
<p style="text-align:center;font-size:0.95rem;line-height:1.5;margin-bottom:0.5rem">Use XP to gain and upgrade powerful sigils. Chase Tapo through a portal torn open by the Flydra! On death, you'll have a chance to spend the gold you've earned to make your heroes permanently stronger!</p>
