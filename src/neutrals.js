...
As a birthday gift, <strong>Mage</strong> has promised to teach Tapo how to catch flies.
</p>
`
}
];
...
html: `<div style="font-size:3rem;font-weight:bold;line-height:1.5;text-align:center;color:#fff;text-shadow:2px 2px 8px rgba(0,0,0,0.9);max-width:600px;letter-spacing:0.05em">WAIT...<br>WHERE IS TAPO??!</div>`,
bgColor: '#000',
