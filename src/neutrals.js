...
<h2 style="text-align:center;margin:0 0 1.5rem 0;font-size:1.8rem;color:#4f46e5">🐸 FROGGLE 🐸</h2>

<div style="text-align:center;margin-bottom:1.5rem">
<p style="font-size:1.1rem;font-weight:bold;margin:0 0 0.25rem 0;color:#1e1b4b">Created by</p>
<p style="font-size:1.4rem;font-weight:bold;margin:0;color:#22c55e">Wes Pecor</p>
</div>

<div style="background:#f0fdf4;border:2px solid #22c55e;border-radius:8px;padding:1rem;margin-bottom:1rem">
<p style="font-size:0.95rem;margin:0;line-height:1.5;text-align:center;color:#166534">
A tactical turn-based roguelike built with love, frogs, and an unreasonable amount of sigils.
</p>
</div>

<div style="text-align:center;margin-bottom:1.5rem">
<h3 style="font-size:1rem;margin:0 0 0.5rem 0;color:#6366f1">Special Thanks</h3>
<p style="font-size:0.9rem;margin:0;color:#4b5563;line-height:1.6">
Claude (AI Assistant)<br>
All the playtesters and frog enthusiasts
</p>
</div>

<div style="text-align:center;margin-bottom:1.5rem;padding:0.75rem;background:#fef3c7;border-radius:8px">
