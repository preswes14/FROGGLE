...
if(best === 1) {
outcome = 'You lose your grip and plummet, smacking your head on the stone! The landing is brutal, and some coins got knocked out of your pouch.';
hpLoss = 3;
goldGain = -5;
...
let outcome = '';
if(best >= 1 && best <= 10) {
outcome = `As you try to sneak by, someone's foot catches on a loose stone! The resulting clatter draws the enemies right to you before you can prepare. It's an ambush!`;
...
'They hold hands and embrace you in a ghostly hug. "We would have never figured it out without you. Thank you." They vanish peacefully.',
...
description: `A flummoxed ${S.royalTitle} paces anxiously: "Please, you must help! A creature in the next chamber ate my beloved's engagement ring! But I have cooked up a strategem to retrieve it! If you can but stun a foe on the first turn of battle, I can search for the ring!"`,
buttons: `
