...
tapo.style.cssText = 'position:absolute;left:35%;bottom:20%;width:120px;height:auto;z-index:5;filter:drop-shadow(2px 2px 4px rgba(0,0,0,0.5));animation:tapoVaultToMage 2s ease-in-out forwards';
