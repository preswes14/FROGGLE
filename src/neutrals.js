...
v.classList.add('no-scroll');
v.innerHTML = `
<div onclick="window.titleCardClicked && window.titleCardClicked()" style="width:100%;height:calc(100vh - 44px);background:#000;display:flex;align-items:center;justify-content:center;cursor:pointer">
...
window.titleCardClicked = proceed;
